{
    ...
    'summary': """  
        RMA / Website rma - Return Merchandise Authorization is an application that helps to manage the return product process and to do analysis over the reason, inventory management technique, rma, return merchandise authorization, replacement product, exchange product, return product,
        exchange return, buy back, refund, coverage ratio,
