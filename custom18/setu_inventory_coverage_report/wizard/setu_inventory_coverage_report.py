...
class SetuInventoryCoverageReport(models.TransientModel):
    ...
    def _check_date_validation(self):
        ...
        if self.start_date > self.end_date:
            raise ValidationError(_("Start date must be earlier than the End date"))

    @api.constrains('coverage_days')
    def _check_coverage_days(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: checks coverage days should be greater than 0
        """
    ...
    def _onchange_coverage_strategy(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: coverage days will be 0 when coverage_ratio_strategy selection change
        """
    ...
    def _categories_wise_product(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: display products according to selected product categories
        """
    ...
    def _company_wise_warehouse(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: display warehouses according to selected companies
        """
    ...
    def onchange_report_by(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: internal_transfers_as_sales boolean reset when change in report_by selection field
        """
    ...
    def get_file_name(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: used to set filename of report excel file
        """
    ...
    def get_inventory_coverage_report_data(self, for_reporting=False):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: Method returns Stock data/query result
        """
    ...
    def prepare_data_to_write(self, stock_data={}):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: prepare data company wise or warehouse wize
        """
        company_wise_data = {}
    ...
    def download_report(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: used to download report in excel file format
        """
    ...
    def download_report_in_listview(self):
        """
            Added By: Shivam Pandya | Date: 21st Oct,2024 | Task: 898
            Use: display report in list view
        """
        ...
        list_view_id = self.env.ref(
            'setu_inventory_coverage_report.setu_inventory_coverage_analysis_bi_report_list').id
