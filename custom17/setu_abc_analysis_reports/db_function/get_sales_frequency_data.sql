        ...
        ELSE
            ...
            (
                ...
                UNION ALL
                    ...
                    and pso.date_order::date >= start_date and pso.date_order::date <= end_date
                    --company dynamic condition
                    and 1 = case when array_length(company_ids,1) >= 1 then
                    ...
                    group by pso.company_id, cmp.name, pol.product_id, pro.default_code, tmpl.categ_id, cat.complete_name, spt.warehouse_id, ware.name, pso.id
                ) foo
            )T
            group by cmp_id, cmp_name, p_id, prod_name, categ_id, cat_name, wh_id, ware_name;
