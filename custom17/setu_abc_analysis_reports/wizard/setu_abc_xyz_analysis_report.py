...
class SetuABCYZAnalysisReport(models.TransientModel):
    ...
    products_ids = fields.Many2many("product.product", 'abc_xyz_analysis_report_product_rel',
                                    'abc_xyz_analysis_report_id',
                                    'products_id',
                                    string="Products",
    ...
    def set_report_title(self, workbook, worksheet):
        ...
        worksheet.merge_range(0, 0, 1, 9, "ABC-XYZ Combined Analysis Report", wb_format)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 5, 'ABC Classification', odd_normal_right_format)
        worksheet.write(row, 6, 'Current Stock', even_normal_right_format)
        worksheet.write(row, 7, 'Stock Value', odd_normal_right_format)
        worksheet.write(row, 8, 'XYZ Classification', even_normal_right_format)
        worksheet.write(row, 9, 'ABC-XYZ Classification', odd_normal_right_format)
    ...
    def write_data_to_worksheet(self, workbook, worksheet, data, row):
        ...
        worksheet.write(row, 5, data.get('abc_classification', ''), odd_normal_center_format)
        worksheet.write(row, 6, data.get('current_stock', ''), even_normal_right_format)
        worksheet.write(row, 7, data.get('stock_value', ''), odd_normal_right_format)
        worksheet.write(row, 8, data.get('xyz_classification', ''), even_normal_center_format)
        worksheet.write(row, 9, data.get('combine_classification', ''), odd_normal_center_format)
        return worksheet
